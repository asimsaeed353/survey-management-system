...
<x-layout>
    ...
    <div class="grid grid-cols-1 gap-5 mx-auto py-5 items-center justify-center bg-white rounded-lg shadow-md mb-5">
        <form method="POST" action="/update-profile/{{$user->_id}}" class="mx-auto px-10 py-5 md:py-0 max-h-[500px] self-center">
            ...
            <div class="md:text-[1.25rem]">
                ...
                <x-form-input class="bg-gray-50" name="name" type="text"  placeholder="Enter your name" value="{{ $user->name}}"/>

                <x-form-error name="name" />
            </div>
            <div class="md:text-[1.25rem] mt-4">
                <x-form-label for="email">Email</x-form-label>
                <x-form-input class="bg-gray-50" name="email" type="email"  placeholder="example@test.com" value="{{ $user->email  }}"/>
            ...
            <div class="md:text-[1.25rem] mt-4">
                ...
                <x-form-input class="bg-gray-50" name="password" type="password" />
            ...
            <div class="md:text-[1.25rem] mt-4">
                ...
                <x-form-input class="bg-gray-50" name="password_confirmation" type="password" />
