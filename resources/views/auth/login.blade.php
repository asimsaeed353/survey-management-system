...
<x-head>
    ...
    <div class="mt-30 md:mt-40 h-fit w-fit mx-auto">
        ...
        <div class=" md:rounded-lg md:flex md:items-center md:justify-center md:shadow-lg">
            ...
            <div class="rounded-lg md:rounded-l-none flex flex-col justify-center md:max-h-[375px] md:min-h-[375px] shadow-lg md:shadow-none md:rounded-r-lg bg-white ">
                ...
                <form action="/login" method="POST" class="rounded-lg md:rounded-r-lg px-10 py-5 ">
                    ...
                    <p class="text-slate-800 mt-5">Don't have an account? <a href="/signup" class="text-[#0092C2] hover:underline ml-1 whitespace-nowrap font-semibold">Register here</a></p>
                </form>
            </div>
        </div>
    </div>
