{{--                Short Questions div --}}
<div class="grid grid-cols-1 gap-5 bg-[#E7F9FF] rounded-lg p-5 short-question" data-index="__INDEX__">
    <div>
        <input type="hidden" name="questions[__INDEX__][type]" value="short">
        <textarea name="questions[__INDEX__][question]" rows="1"
