...
<x-layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 lg:gap-7 mb-3">
        ...
        <div class="bg-white w-full flex flex-col items-center justify-around rounded-xl gap-5 shadow-lg px-3 py-2">
            ...
            <div class="p-1 py-5 flex flex-col gap-5 items-center justify-center">
                <div>
                    <h3 class=" text-center text-[1.65rem]">Hello <span class="text-[1.65rem] font-bold">{{Auth::user()->name}}!</span>
                    </h3>
                    <p class="text-center text-[#7D7D7D] text-[0.875rem] px-6">Collect better data and make better
                        decisions.</p>
                </div>

                <div>
                    <x-button href="/survey/create" class="group px-3 py-1 gap-3 w-fit ">Create Survey
